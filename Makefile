.PHONY: install install-browsers format format-check lint typecheck test test-unit test-integration test-native test-e2e coverage docs-check actionlint build check dev-server dev-web
...
check: format-check lint typecheck docs-check test test-native build test-e2e
